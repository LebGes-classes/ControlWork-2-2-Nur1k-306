...
public class Main {
    public static void main(String[] args) {
        ...
        // Заданное время для поиска текущих программ (например, 15:30)
        BroadcastsTime searchTime = new BroadcastsTime("15:30");
        ...
        String outputFilePath = "sorted_data.xlsx";

        try (Workbook workbook = new XSSFWorkbook()) {
            Sheet sheet = workbook.createSheet("TV Schedule");
            int rowNum = 0;
